                    ...
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container mt-5">
                                <h5>Edit Data Obat Masuk Gudang "<?= $ObatMasuk[0]['NamaObat'] ?>"</h5>
                                <form method="POST" action="<?= base_url('obatmasuk/data/updateOMG') ?>">
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Nama Obat</label>
                                        <input type="text" class="form-control" id="NamaObat" name="NamaObat" value="<?= $ObatMasuk[0]['NamaObat'] ?>" readonly="readonly">
                                        <input type="text" id="IdObatMasuk" name="IdObatMasuk" value="<?= $ObatMasuk[0]['IdObatMasuk'] ?>" hidden>
                                        <input type="text" id="IdObat" name="IdObat" value="<?= $ObatMasuk[0]['IdObat'] ?>" hidden>
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Dinkes</label>
                                        <input type="text" class="form-control" id="Dinkes" name="Dinkes" value="<?= $ObatMasuk[0]['Dinkes'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Blud</label>
                                        <input type="text" class="form-control" id="Blud" name="Blud" value="<?= $ObatMasuk[0]['Blud'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Nama Obat</label>
                                        <input type="text" class="form-control" id="BulanMasuk" name="BulanMasuk" value="<?= $ObatMasuk[0]['BulanMasuk'] ?>" readonly="readonly">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Nama Obat</label>
                                        <input type="text" class="form-control" id="TahunMasuk" name="TahunMasuk" value="<?= $ObatMasuk[0]['TahunMasuk'] ?>" readonly="readonly">
                                    </div>
