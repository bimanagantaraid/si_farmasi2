                    ...
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container">
                                ...
                                <form method="POST" action="<?= base_url('dataobat/obat/updateDataObat') ?>">
                                    <div class="mb-3">
                                        <input type="text" id="IdObat" name="IdObat" value="<?= $obat[0]['IdObat'] ?>" hidden>
                                        <label for="NamaObat" class="form-label">Nama Obat</label>
                                        <input type="text" class="form-control" id="NamaObat" name="NamaObat" value="<?= $obat[0]['NamaObat']; ?>">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="SatuanObat" name="SatuanObat">
                                            <option selected value="<?= $obat[0]['SatuanObat']; ?>"><?= $obat[0]['SatuanObat']; ?></option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php
                                        $valueHargaSatuanObat = 0;
                                        if ($obat[0]['HargaSatuanObat'] === NULL) {
                                            $valueHargaSatuanObat = 0;
                                        } else {
                                            $valueHargaSatuanObat = $obat[0]['HargaSatuanObat'];
                                        }
                                        ?>
                                        <input type="text" class="form-control" id="HargaSatuanObat" name="HargaSatuanObat" value="<?= $valueHargaSatuanObat; ?>">
                                    </div>
