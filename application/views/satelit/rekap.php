...
<head>
    ...
    <title>Data Satelit <?= $filterData[2] ?> Pada <?= $monthName . ' ' . $filterData[1] ?></title>
                ...
                <div class="px-4 py-3">
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container">
                                <h5 id="title">Data Satelit <?= $filterData[2] ?> Pada <?= $monthName . ' ' . $filterData[1] ?></h5>
                                <div class="row">
                                    <div class="col">
...
<script>
    $(document).ready(function() {
        tableobatmasukgudang = $('#table-satelit-rekap').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('satelit/data/getrekap/') . $filter ?>",
                "type": "POST",
                "dataType": "JSON"
            }
        });
