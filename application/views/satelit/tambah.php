                ...
                <div class="px-4 py-3">
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container">
                                <h5>Tambah Data Mutasi Satelit</h5>
                                <form method="POST" action="<?= base_url('satelit/data/tambahdata') ?>">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="MutasiKeluar" name="MutasiKeluar">
                                    </div>
                                    <div class="mb-3">
                                        <label for="Blud" class="form-label">Mutasi ED</label>
                                        <input type="text" class="form-control" id="EDSatelit" name="EDSatelit">
                                    </div>
                                    <div class="mb-3 row">
        ...
        $(document).ready(function() {
            ...
            function loadanggota() {
                $('#InputNamaObat').keyup(function() {
                    var search = $(this).val();
                    $.ajax({
                        url: "<?php echo site_url('dataobat/obatmasuk/getobatinsert'); ?>",
                        method: "POST",
                        async: true,
                        data: {
                            query: search
