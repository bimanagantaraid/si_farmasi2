...
<head>
    ...
    <title>Tambah Obat Distribusi Ke Satelit</title>
</head>
                ...
                <div class="px-4 py-3">
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <h5>Tambah Data Obat Keluar Gudang ke Satelit</h5>
                            <form method="POST" action="<?= base_url('obatkeluar/data/insertData') ?>">
                                <div class="mb-3">
