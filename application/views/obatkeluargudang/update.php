                ...
                <div class="px-4 py-3">
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container">
                                <h5>Edit Data Obat Keluar Gudang "<?= $DataOKG[0]['NamaObat'] ?>"</h5>
                                <form method="POST" action="<?= base_url('obatkeluar/obat/updateOKG') ?>">
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Nama Obat</label>
                                        <input type="text" class="form-control" id="NamaObat" name="NamaObat" value="<?= $DataOKG[0]['NamaObat'] ?>" readonly="readonly">
                                        <input type="text" id="IdObat" name="IdObat" value="<?= $DataOKG[0]['IdObat'] ?>" hidden>
                                        <input type="text" id="IdSatelit" name="IdSatelit" value="<?= $DataOKG[0]['IdSatelit'] ?>" hidden>
                                        <input type="text" id="IdObatKeluar" name="IdObatKeluar" value="<?= $DataOKG[0]['IdObatKeluar'] ?>" hidden>
                                    </div>
                                    <div class="mb-3">
                                        <label for="JumlahObatKeluar" class="form-label">Jumlah Obat keluar</label>
                                        <input type="text" class="form-control" id="JumlahObatKeluar" name="JumlahObatKeluar" value="<?= $DataOKG[0]['JumlahObatKeluar'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Bulan Obat Keluar</label>
                                        <input type="text" class="form-control" id="BulanObatKeluar" name="BulanObatKeluar" value="<?= $DataOKG[0]['BulanObatKeluar'] ?>" readonly="readonly">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NamaObat" class="form-label">Tahun Obat Keluar</label>
                                        <input type="text" class="form-control" id="TahunObatKeluar" name="TahunObatKeluar" value="<?= $DataOKG[0]['TahunObatKeluar'] ?>" readonly="readonly">
                                    </div>
