                ...
                <div class="px-4 py-3">
                    <article>
                        ...
                        <div class="px-4 py-4 mt-4 shadow halaman">
                            <div class="container">
                                <h5>Generate Data Obat Keluar Gudang Ke Satelit</h5>
                                <p class="text-danger">*Pastikan data benar karena disini mengenerate semua data obat kedalam gudang sesuai pilihan bulan dan tahun</p>
                                <p class="text-danger">Silahkan Tunggu Sampai Proses Generate Selesai, Jangan tutup Browser</p>
                                <form method="POST" action="<?= base_url('obatkeluar/data/generateObatSatelit') ?>">
                                    <div class="mb-3">
                                        <label for="Dinkes" class="form-label">Jumlah Obat Distribusi Ke Satelit</label>
                                        <input type="text" class="form-control" id="JumlahObatKeluar" name="JumlahObatKeluar">
                                    </div>
                                    <div class="mb-3 row">
                                        <div class="bulanmasuk col">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <label class="input-group-text" for="BulanObatKeluar">Bulan Obat Keluar</label>
                                                </div>
                                                <select name="BulanObatKeluar" id="BulanObatKeluar" class="custom-select">
                                        ...
                                        <div class="tahunmasuk col">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <label class="input-group-text" for="TahunObatKeluar">Tahun Obat keluar</label>
                                                </div>
                                                <input type="text" class="form-control" id="TahunObatKeluar" name="TahunObatKeluar">
                                            </div>
                                        </div>
                                        <div class="satelit col">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <label class="input-group-text" for="IdSatelit">Satelit</label>
                                                </div>
                                                <select name="IdSatelit" id="IdSatelit" class="custom-select">
