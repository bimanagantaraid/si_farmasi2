    ...
    class ObatKeluar extends CI_Controller{
        function getObatKeluar(){
            ...
            foreach ($list as $item) {
                ...
                $row[] = "<a href='" . base_url('dataobat/obatkeluar/update/') . $item->IdObatKeluar . "'><button type='button' class='btn btn-sm btn-primary m-1'>Edit</button></a><a href='" . base_url('dataobat/obatkeluar/delete/') . $item->IdObatKeluar . "'><button type='button' class='btn btn-sm btn-danger m-1'>Hapus</button></a>";
                $data[] = $row;
            }
            $output = array(
                "draw" => @$_POST['draw'],
        ...
        function exportExcelOKG(){
            ...
            $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('DX9', 'OBAT ED di GUDANG INDUK')
                        ->mergeCells('DX9:EI9')
                        ->setCellValue('DX10','Jan')
                        ->setCellValue('DY10','Feb')
                        ->setCellValue('DZ10','Mar')
                        ->setCellValue('EA10','Apr')
                        ->setCellValue('EB10','Mei')
                        ->setCellValue('EC10','Jun')
                        ->setCellValue('ED10','Jul')
                        ->setCellValue('EE10','Ags')
                        ->setCellValue('EF10','Sep')
                        ->setCellValue('EG10','Okt')
                        ->setCellValue('EH10','Nov')
                        ->setCellValue('EI10','Des')
                        ->setCellValue('EJ9','TOTAL ED GUDANG')
                        ->mergeCells('EJ9:EJ10');
            ...
            $spreadsheet->getActiveSheet()->getStyle('DX9:EI9')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);  
